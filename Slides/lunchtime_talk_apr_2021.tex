...
\begin{frame}{Pittsburgh, 1995}
  \begin{itemize}
    \pause
  \item \emph{Unskilled and Unaware of It} - Dunning / Kruger Effect
    \pause
...
\begin{frame}{Incremental Development - Covered}
  ...
  \item Slime is neat: can navigate to language definitions easily
    \pause    
  \item \textbf{Easy to flip between code and evaluating / compiling code.}
  \end{itemize}
\end{frame}
...
\begin{frame}{CLOS Demo - Covered}
  \begin{itemize}
  \item Functions ``more important than'' objects
  \item Can do wild and funky things
  \end{itemize}
\end{frame}
...
\begin{frame}{Nifty Tools - Covered}
  ...
  \item Carpentry vs Teaching
    \pause    
  \item Fast / Slow; Slow Fast \pause Profiling + Type \& Memory Declarations
  \end{itemize}
\end{frame}

\section{Why Common Lisp Is Hardy}
\begin{frame}{Why Common Lisp is Hardy}
  \begin{itemize}
    \pause
  \item Macros
  \end{itemize}
...
\begin{frame}{Conclusion}
  \begin{itemize}
    \pause
  \item Lisp is old and elegant.
    \pause
  \item Syntax is odd, but simple. 
    \pause    
  \item Different style of OO.
    \pause    
